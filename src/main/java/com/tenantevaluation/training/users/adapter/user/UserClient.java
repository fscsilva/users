...
import com.tenantevaluation.training.users.domain.port.services.UserService;
    ...
    public User getUserByUsername(String username) {
        ...
        return roleRepository.findRoleEntityById(roleId)
            .map(roleEntity -> User.builder()
                ...
                .authorities(Collections.singletonList(new SimpleGrantedAuthority(roleEntity.getRoleName())))
                .build())
